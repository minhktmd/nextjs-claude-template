...
| Skill | Use when |
|-------|---------|
| `react-best-practices` | Writing components, data fetching, optimization |
| `react-composition-patterns` | Designing shared components |

### Note on barrel imports

`react-best-practices` includes a rule against barrel imports. In this template:
